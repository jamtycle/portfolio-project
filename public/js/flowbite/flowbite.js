...
var Modal = /** @class */ (function () {
    ...
    Modal.prototype.show = function () {
        if (this.isHidden) {
            ...
            this._targetEl.classList.add("alpha-appear-fast");
            this._backdropEl.classList.add("alpha-appear-fast");
            setTimeout(() => {
                this._targetEl.classList.remove("alpha-appear-fast");
                this._backdropEl.classList.remove("alpha-appear-fast");
            }, 300);
    ...
    Modal.prototype.hide = function () {
      if (this.isVisible) {
        this._targetEl.classList.add("alpha-disappear-fast");
        this._backdropEl.classList.add("alpha-disappear-fast");
        setTimeout(() => {
          this._targetEl.classList.remove("alpha-disappear-fast");
          this._backdropEl.classList.remove("alpha-disappear-fast");
          this._targetEl.classList.add('hidden');
